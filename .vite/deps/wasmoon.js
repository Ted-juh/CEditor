...
//#endregion
//#region CE/web/node_modules/wasmoon/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		...
		const LUA_REGISTRYINDEX = -1001e3;
		...
		class Thread {
			...
			assertOk(result) {
				if (result !== exports$1.LuaReturn.Ok && result !== exports$1.LuaReturn.Yield) {
					...
					if (this.getTop() > 0) {
						if (result === exports$1.LuaReturn.ErrorMem) error.message = this.lua.lua_tolstring(this.address, -1, null);
						else {
			...
			loadLibrary(library) {
				switch (library) {
					...
					case exports$1.LuaLibraries.Debug:
						...
						break;
					case exports$1.LuaLibraries.Package: this.lua.luaopen_package(this.address);
				}
		...
		var initWasmModule = (() => {
			var _scriptDir = typeof document === "undefined" && typeof location === "undefined" ? require_browser_external_url().pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href;
			return (async function(moduleArg = {}) {
				...
				if (n) {
					...
					const { createRequire: a } = await import("./browser-external_module-Ca5SjB1x.js").then((m) => /* @__PURE__ */ __toESM(m.default));
					var require$1 = a(typeof document === "undefined" && typeof location === "undefined" ? require_browser_external_url().pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href), fs = require$1("fs"), na = require$1("path");
					k ? r = na.dirname(r) + "/" : r = require$1("url").fileURLToPath(new URL("./", typeof document === "undefined" && typeof location === "undefined" ? require_browser_external_url().pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href));
					ia = (b, c) => {
				...
				var Ca = /* @__PURE__ */ new Int16Array(1), Da = new Int8Array(Ca.buffer);
				Ca[0] = 25459;
				...
				} else M = new URL("glue.wasm", typeof document === "undefined" && typeof location === "undefined" ? require_browser_external_url().pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href).href;
				function Qa(a) {
					if (ka) return ka(a);
		...
		class LuaWasm {
			static async initialize(customWasmFileLocation, environmentVariables) {
				const module$1 = await initWasmModule({
				...
				return new LuaWasm(module$1);
			}
			constructor(module$2) {
				...
				return (...args) => {
					...
					const resolvedArgTypes = argTypes.map((argType, i) => {
						...
						if (argType === "string|number") {
							if (typeof args[i] === "number") return "number";
