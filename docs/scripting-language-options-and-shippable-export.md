...
| 3 | **Template player** | VST3 verified on Windows on 13 September 2026: distinct names/IDs, automation, state restore and window-closed Lua/JS/TS MIDI output in CEditor's isolated native host. CLAP/LV2 templates are skipped with a build-log warning because their wrappers still use build-time identities; old panels still export VST3. Third-party DAW acceptance remains open. |
