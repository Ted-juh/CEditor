...
export function defaultSource(eventName = 'onValueChanged', languageId = 'lua') {
  ...
  if (hook) {
    ...
    if (eventName === 'onPanelReady') {
      ...
      if (isCs) return `void onPanelReady(CeContext ctx, CeEvent e) {\n  if (e.firstTime) {\n    \n  }\n}\n`;
      return isJs
