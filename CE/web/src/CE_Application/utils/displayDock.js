 ...
 */
export const EDITOR_TAB_BY_KIND = { effects: 'effects', typography: 'type', assets: 'assets', screen: 'screen', api: 'api', animation: 'animation' };
 ...
 */
export const DISPLAY_DOCK_TAB_DEFAULT_HEIGHTS = { colors: 320, gradient: 380, effects: 380, type: 380, assets: 380, screen: 420, api: 400, library: 420, animation: 420 };
