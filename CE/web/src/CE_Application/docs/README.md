...
| Macro & Snapshot-Morph | Component | 📝 design | Macro = Knob + Mapper; Snapshot-Morph = blend control + Snapshots. Both emergent from the foundations (mostly packaging + assign UI). | [macro-and-morph.md](./macro-and-morph.md) |
...
| Auto-Panel generator | Feature | 📝 design | DPD → a complete editor panel (control-per-param, grouped, type-chosen). Biggest adoption unlock; reuses DPD + factory + binding. | [auto-panel.md](./auto-panel.md) |
