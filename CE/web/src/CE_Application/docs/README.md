...
| Number Field component | Component | 📝 spec (presets) | Number entry + steppers already exists as the Range/spinbox; gap is naming + a bare variant. Recommended: Range palette presets (~2 files), not a new controlType. | [number-field-component.md](./number-field-component.md) |
