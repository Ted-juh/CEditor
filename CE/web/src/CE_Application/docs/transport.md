...
**Every self-clocked component in the panel follows it.** There are eight, and
...
| [Phrase Recorder](./phrase-recorder.md) | bars | a tempo change keeps the phrase the same length in music |
