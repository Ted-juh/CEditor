...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      treeshake: false,
      input: ['sceneryGround', 'textPlacement', 'midi', 'monitor', 'strip', 'playerInbound', 'learnChips', 'panelShot', 'effectsTab', 'typographyTab', 'assetsTab', 'screenTab', 'apiTab', 'libraryTab', 'animationTab', 'designerTab', 'dockOpeners', 'propertyFilter', 'panelStrip'].map(page),
    },
  },
});
