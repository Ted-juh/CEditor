...
try {
 ...
 await page.locator('.text-dock').waitFor();await page.locator('.studio-rail').getByRole('tab',{name:'Screen',exact:true}).click();await dock.waitFor();
 ...
 await group('Content');
 await page.locator('.studio-rail').getByRole('tab',{name:'Colors',exact:true}).click();
 await page.locator('.studio-rail').getByRole('tab',{name:'Screen',exact:true}).click();await dock.waitFor();
 ...
 await page.locator('.studio-rail').getByRole('tab',{name:'Effects',exact:true}).click();const effects=page.locator('.effects-tab');await effects.waitFor();
 ...
 await page.locator('.studio-rail').getByRole('tab',{name:'Screen',exact:true}).click();await dock.waitFor();await group('Appearance');
