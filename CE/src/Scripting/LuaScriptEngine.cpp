...
-- @module ce.components.arp
  ...
  "arpBaseOctave","arpSource","arpEditable","arpShowNotes","arpShowHeader","arpRead",
...
-- @module ce.components.router
  ...
  "routerEditable","routerShowGrid","routerShowDivisions","routerRead","routerSize","routerFill",
...
-- @module ce.components.envelope
  ...
  "envelopeAddOnDoubleClick","envelopeSnapX","envelopeSnapY","envelopeFillUnder","envelopeEditable",
  "envelopeShowPlayhead","envelopeShowGrid","envelopeRead","envelopeSize","envelopeFill",
  "envelopeInsert","envelopeRemove",
...
-- @module ce.components.meter
  ...
  "meterValuePrecision","meterValuePrefix","meterValueSuffix","meterZoneAt","meterShowTicks",
  "meterShowScaleLabels","meterShowValue","meterRead","meterSize","meterFill","meterInsert",
  "meterRemove",
...
-- @module ce.components.lcd
  ...
  "lcdValueMin","lcdValueMax","lcdValuePrecision","lcdValuePrefix","lcdValueSuffix","lcdShowGlass",
...
-- @module ce.components.pixel
  ...
  "pixelTransitionMs","pixelShowGlass","pixelShowGhost","pixelShowScanlines","pixelShowGrid",
  "pixelRead",
}
-- @module -
...
local __CE_MODULES = {
  ...
  ["ce.components.arp"] = { baseOctave = "arpBaseOctave", channel = "arpChannel", chordType = "arpChordType", degree = "arpDegree", division = "arpDivision", editable = "arpEditable", euclid = "arpEuclid", euclidPulses = "arpEuclidPulses", euclidRotate = "arpEuclidRotate", euclidSteps = "arpEuclidSteps", gate = "arpGate", inputChannel = "arpInputChannel", key = "arpKey", latch = "arpLatch", mute = "arpMute", octaves = "arpOctaves", pattern = "arpPattern", phase = "arpPhase", rate = "arpRate", read = "arpRead", run = "arpRun", scale = "arpScale", showHeader = "arpShowHeader", showNotes = "arpShowNotes", source = "arpSource", swing = "arpSwing", sync = "arpSync", velocity = "arpVelocity" },
  ...
  ["ce.components.lcd"] = { anim = "lcdAnim", animFps = "lcdAnimFps", animLoop = "lcdAnimLoop", animPreset = "lcdAnimPreset", animSpeed = "lcdAnimSpeed", backlight = "lcdBacklight", blink = "lcdBlink", blinkRate = "lcdBlinkRate", brightness = "lcdBrightness", clear = "lcdClear", contrast = "lcdContrast", cursor = "lcdCursor", cursorAt = "lcdCursorAt", cursorBlink = "lcdCursorBlink", fill = "lcdFill", read = "lcdRead", scroll = "lcdScroll", scrollMode = "lcdScrollMode", scrollRepeat = "lcdScrollRepeat", scrollSpeed = "lcdScrollSpeed", showGhost = "lcdShowGhost", showGlass = "lcdShowGlass", showGrid = "lcdShowGrid", showScanlines = "lcdShowScanlines", size = "lcdSize", text = "lcdText", value = "lcdValue", valueMax = "lcdValueMax", valueMin = "lcdValueMin", valuePrecision = "lcdValuePrecision", valuePrefix = "lcdValuePrefix", valueSuffix = "lcdValueSuffix" },
  ["ce.components.pixel"] = { anim = "pixelAnim", animFps = "pixelAnimFps", animLoop = "pixelAnimLoop", animPreset = "pixelAnimPreset", animSpeed = "pixelAnimSpeed", backlight = "pixelBacklight", brightness = "pixelBrightness", contrast = "pixelContrast", gamma = "pixelGamma", glow = "pixelGlow", layoutTransition = "pixelLayoutTransition", read = "pixelRead", showGhost = "pixelShowGhost", showGlass = "pixelShowGlass", showGrid = "pixelShowGrid", showScanlines = "pixelShowScanlines", transitionMs = "pixelTransitionMs" },
}
