...
- **Java cost is now modest** (resolved). The hosted-JVM path dropped GraalVM's minutes-long/​8–16 GB
  ...
  ~40 MB JRE in the bundle, same "ship a runtime" trade as C# (~22 MB trimmed CoreCLR) and Python (~11 MB).
