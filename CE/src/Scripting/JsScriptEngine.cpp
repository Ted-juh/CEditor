...
// @module ce.components.lcd
  ...
  "lcdValueSource","lcdBrightnessSource","lcdBacklightSource","lcdEditText","lcdShowGlass",
  "lcdShowGhost","lcdShowScanlines","lcdShowGrid","lcdRead","lcdSize","lcdFill",
